 ...
 * @author ALUNO
 */
@WebServlet(name = "ServletExibirImagemDoguinhoGambiarra", urlPatterns = {"/ServletExibirImagemDoguinhoGambiarra"})
public class ServletExibirImagemDoguinhoGambiarra extends HttpServlet {
